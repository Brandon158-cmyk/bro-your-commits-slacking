		...
		<div className='min-h-screen flex flex-col items-center justify-center p-6'>
			<div className='max-w-xl w-full'>
				<HandDrawnCard variant='notebook' className='mb-8'>
					<div className='flex flex-col items-center text-center'>
						<h1 className='text-4xl md:text-5xl font-handwritten mb-4 text-pencil-dark'>
							...
							<span className='block text-ink-red animate-wobble inline-block'>
								Slacking?
							</span>
						</h1>

						<p className='mb-8 text-xl'>
							Let's check if you're crushing your GitHub game or if your ops are
							catching up! 🔍
						</p>
				...
				<HandDrawnCard className='text-center'>
					...
					<p className='mb-4'>
						This playful app checks your GitHub commit activity and tells you if
						you're crushing it or slacking on your projects.
					</p>
					<p>
